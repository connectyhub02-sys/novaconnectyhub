...
Desde 15/09/2026, a Betel possui aplicação e Supabase dedicados na VPS; usa o Inngest existente por broker específico e mantém carteira/organização próprias na ConnectyHub. A ConnectyHub principal continua na Vercel. O portal de infraestrutura consulta fontes reais de cada projeto em leitura; não compartilha contas administrativas nem carteiras. Desde 15/09 às 20:29 UTC, novas automações/webhooks Betel estão habilitados; somente trabalhos históricos incertos permanecem retidos. A sincronização de histórico consultava três instâncias arquivadas; filtro corrigido e publicado às 20:57 UTC, ainda pendente de resultado natural após essa publicação. Consulte a [ativação operacional](betel-ativacao-operacional-2026-09-15.md), que distingue execução técnica de validação comercial. Consulte o [relatório da migração](betel-migracao-vps-2026-09-15.md) antes de operar ou reativar trabalhos antigos.
