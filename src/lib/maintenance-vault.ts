...
export const maintenanceIntegrations: IntegrationDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      {
        label: "Client ID",
        env: "PAGBANK_CLIENT_ID",
        aliases: ["PAGSEGURO_CLIENT_ID"],
        kind: "identifier",
        requirement: "required",
        help: "Client ID do aplicativo PagBank Connect Authorization criado para a ConnectyHub.",
      },
      {
        label: "Client Secret",
        env: "PAGBANK_CLIENT_SECRET",
        aliases: ["PAGSEGURO_CLIENT_SECRET"],
        kind: "secret",
        requirement: "required",
        help: "Client Secret do aplicativo PagBank. Fica somente no servidor da ConnectyHub.",
      },
      {
        label: "Token do app PagBank",
        env: "PAGBANK_CONNECT_TOKEN",
        aliases: ["PAGBANK_AUTHORIZATION_TOKEN", "PAGBANK_APP_TOKEN", "PAGSEGURO_AUTH_TOKEN", "PAGSEGURO_CONNECT_TOKEN"],
        kind: "secret",
        requirement: "required",
        help: "Token Bearer usado pela API PagBank para trocar o code OAuth por access token e renovar refresh tokens.",
      },
      {
        label: "Redirect URI",
        env: "PAGBANK_REDIRECT_URI",
        aliases: ["PAGSEGURO_REDIRECT_URI"],
        kind: "endpoint",
        requirement: "recommended",
        help: "URL de retorno cadastrada no app PagBank: https://www.connectyhub.com.br/api/dashboard/sales-catalog/payments/pagbank/callback.",
      },
      {
        label: "Link afiliado PagBank",
        env: "PAGBANK_AFFILIATE_CONNECT_URL",
        kind: "endpoint",
        requirement: "recommended",
        help: "URL oficial de afiliado/parceria. Pode incluir placeholders {continueUrl}, {authorizationUrl}, {state} e {companyId}.",
      },
      {
        label: "Ambiente PagBank",
        env: "PAGBANK_ENVIRONMENT",
        aliases: ["PAGSEGURO_ENVIRONMENT"],
        kind: "identifier",
        requirement: "optional",
        help: "Use production para venda real ou sandbox para homologacao.",
      },
      {
        label: "Webhook token PagBank",
        env: "PAGBANK_WEBHOOK_TOKEN",
        aliases: ["PAGBANK_CONNECT_TOKEN", "PAGBANK_AUTHORIZATION_TOKEN", "PAGSEGURO_CONNECT_TOKEN"],
        kind: "secret",
        requirement: "recommended",
        help: "Token usado para validar notificacoes recebidas em /api/webhooks/pagbank.",
      },
      {
        label: "Webhooks sem assinatura",
        env: "PAGBANK_ALLOW_UNSIGNED_WEBHOOKS",
        kind: "identifier",
        requirement: "optional",
        help: "Use true apenas em homologacao quando o PagBank ainda nao estiver enviando assinatura verificavel.",
      },
    ],
  },
  {
    id: "mercado-pago",
    name: "Mercado Pago / Checkout WhatsApp (standby)",
    sector: "Pagamentos no WhatsApp",
    owner: "Setor Financeiro IA",
    description:
      "Aplicativo OAuth preservado para reativacao futura. A conexao fica oculta no painel do cliente enquanto o rollout principal usa PagBank.",
    tone: "cyan",
  ...
  {
    id: "pagbank-billing",
    name: "PagBank / Cobranca ConnectyHub",
    sector: "Assinaturas e creditos",
    owner: "Setor Financeiro IA",
    description:
      "Credenciais da conta CNPJ PagBank da ConnectyHub usadas para cobrar planos, pacotes e creditos dos clientes da plataforma.",
    tone: "green",
    modules: ["Pix de planos", "Creditos extras", "Webhooks de billing", "Conta CNPJ"],
    fields: [
      {
        label: "Access Token CNPJ",
        env: "PAGBANK_BILLING_ACCESS_TOKEN",
        aliases: ["PAGBANK_BILLING_AUTHORIZATION_TOKEN", "PAGBANK_BILLING_APP_TOKEN"],
        kind: "secret",
        requirement: "required",
        help: "Token de producao da conta CNPJ PagBank da ConnectyHub. Usado somente no servidor para cobrar planos e creditos.",
      },
      {
        label: "Modo cobranca PagBank",
        env: "PAGBANK_BILLING_MODE",
        kind: "identifier",
        requirement: "optional",
        help: "Use production para cobranca real. Use sandbox apenas em homologacao.",
      },
      {
        label: "Webhook billing PagBank",
        env: "PAGBANK_BILLING_WEBHOOK_URL",
        kind: "endpoint",
        requirement: "recommended",
        help: "URL dedicada aos webhooks de cobranca da plataforma: /api/webhooks/pagbank/platform-billing.",
      },
      {
        label: "Webhook token billing",
        env: "PAGBANK_BILLING_WEBHOOK_TOKEN",
        kind: "secret",
        requirement: "recommended",
        help: "Token usado para validar notificacoes PagBank da cobranca da ConnectyHub.",
      },
      {
        label: "Soft descriptor",
        env: "PAGBANK_BILLING_SOFT_DESCRIPTOR",
        kind: "identifier",
        requirement: "optional",
      ...
      },
      {
        ...
        kind: "endpoint",
        requirement: "optional",
        help: "Opcional. Sobrescreve a API PagBank padrao em homologacao ou ambiente especifico.",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        env: "MERCADO_PAGO_BILLING_REFRESH_TOKEN",
        kind: "secret",
        requirement: "recommended",
        help: "Refresh Token salvo automaticamente ao conectar a conta Mercado Pago da ConnectyHub por OAuth. Mantem a cobranca funcionando quando o access token expira.",
      },
      {
        label: "Conta Mercado Pago ConnectyHub",
        env: "MERCADO_PAGO_BILLING_ACCOUNT_ID",
        kind: "identifier",
        requirement: "optional",
        help: "ID da conta Mercado Pago conectada para receber mensalidades e creditos da ConnectyHub.",
      },
      {
        label: "Expiracao do token billing",
        env: "MERCADO_PAGO_BILLING_TOKEN_EXPIRES_AT",
        kind: "identifier",
        requirement: "optional",
        help: "Data ISO salva automaticamente para renovacao segura do token OAuth da conta recebedora.",
      },
      {
        label: "Webhook billing",
        env: "MERCADO_PAGO_BILLING_WEBHOOK_URL",
        kind: "endpoint",
        requirement: "recommended",
        help: "URL dedicada aos webhooks de cobranca da plataforma: /api/webhooks/mercado-pago/platform-billing.",
      },
      {
