    ...
    "@graph": [
      ...
      },
      {
        ...
        featureList: [
          ...
          "Estúdio de Voz e Áudio AI com créditos por operação",
          "API de Voz com arquivos privados por projeto",
        ],
    ...
    "@graph": [
      {
        ...
        "@id": `${docsUrl}#webpage`,
        url: docsUrl,
        name: "Documentação das APIs WhatsApp, AI e Voz ConnectyHub",
        description:
          "Referência pública das APIs WhatsApp, AI e Estúdio de Voz e Áudio AI, com autenticação, créditos, disponibilidade por projeto e OpenAPI JSON.",
        inLanguage: "pt-BR",
        isPartOf: { "@id": `${siteUrl}/#website` },
        mainEntity: [{ "@id": apiId }, { "@id": `${docsUrl}#ia-api` }, { "@id": `${docsUrl}#voz-api` }],
      },
      {
        "@type": "WebAPI",
        "@id": apiId,
        name: "ConnectyHub API WhatsApp",
      ...
      },
      {
        "@type": "WebAPI",
        "@id": `${docsUrl}#voz-api`,
        name: "ConnectyHub Estúdio de Voz e Áudio AI",
        description: "Geração e ferramentas de áudio com chaves por projeto, arquivos privados e créditos por operação. Modalidades e modelos dependem da disponibilidade consultada no catálogo autenticado.",
        documentation: `${docsUrl}#voz`,
        url: buildCanonicalUrl("/api/v1/voice"),
        termsOfService: buildCanonicalUrl("/termos"),
        provider: { "@id": `${siteUrl}/#organization` },
      },
      {
        "@type": "TechArticle",
        "@id": `${docsUrl}#article`,
        headline: "Como integrar as APIs WhatsApp, AI e Voz da ConnectyHub",
        description:
        ...
        about: [{ "@id": apiId }, { "@id": `${docsUrl}#ia-api` }, { "@id": `${docsUrl}#voz-api` }],
      },
      buildBreadcrumbList([
