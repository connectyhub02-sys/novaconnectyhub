    ...
    "@graph": [
      {
        ...
        "@id": `${docsUrl}#webpage`,
        url: docsUrl,
        name: "Documentação das APIs WhatsApp e IA / LLM ConnectyHub",
        description:
          "Referência pública das APIs WhatsApp e IA / LLM, com endpoints, autenticação, exemplos e downloads OpenAPI JSON.",
        inLanguage: "pt-BR",
        isPartOf: { "@id": `${siteUrl}/#website` },
        mainEntity: [{ "@id": apiId }, { "@id": `${docsUrl}#ia-api` }],
      },
      {
        "@type": "WebAPI",
        "@id": apiId,
      ...
      },
      {
        "@type": "TechArticle",
        "@id": `${docsUrl}#article`,
        headline: "Como integrar as APIs WhatsApp e IA / LLM da ConnectyHub",
        description:
        ...
        about: [{ "@id": apiId }, { "@id": `${docsUrl}#ia-api` }],
      },
      buildBreadcrumbList([
