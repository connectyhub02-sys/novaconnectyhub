...
const panelSupportMap = [
  "Painel cliente: Dashboard, Minha Empresa, Leads, Conversas, Agentes, CRM/Funil, Catalogo de Vendas, Automacoes, Produtos, Integracoes, API WhatsApp, Planos e Minha Conta. Indicadores de relatorios ficam no Dashboard. Campanhas fica dentro de Agentes > Grupos e campanhas, no fluxo Campanhas WhatsApp: buscar destinos, selecionar grupos/canais, criar mensagem, revisar e agendar.",
