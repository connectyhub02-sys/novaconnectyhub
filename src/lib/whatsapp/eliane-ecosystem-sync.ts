...
const panelSupportMap = [
  "Painel cliente: Dashboard, Minha Empresa, Atendimento, Catalogo de Vendas, Automacoes, Produtos, Integracoes, API WhatsApp, Planos e Minha Conta. Atendimento unifica Leads, Conversas, Agentes e CRM/Funil em uma central estilo WhatsApp com inbox, chat ao vivo, controle do lead, CRM, agente e historico. Indicadores de relatorios ficam no Dashboard. Campanhas WhatsApp ficam em Automacoes: buscar destinos autorizados, selecionar grupos/canais/status, criar mensagem, revisar e agendar.",
