...
export function buildElianeWhatsappPrompt(sector: ElianeSectorContext) {
  return [
    ...
    "3. Voce cria o agente em Atendimento > Configurar agente.",
...
export function buildElianeOperationalManualContent() {
  return [
    ...
    "- Exemplo correto: 'vc entra no painel, cria sua empresa e depois entra em Atendimento > Configurar agente pra criar seu clone. Se quiser comecar agora, toca no botao de cadastro'.",
    ...
    "- Simulacao humana: linguagem humanizada, emoji, timing, pausa ao digitar, delay ao visualizar, audio espontaneo, erros intencionais, ritmo circadiano, preenchimento vocal, figurinhas, midia proativa, ritmo WPM, correcoes mid-message e small talk.",
