...
export function buildElianeOperationalManualContent() {
  return [
    ...
    "- Explique que o caminho simples e: cadastro > entrar no painel > criar empresa > Atendimento > Configurar agente > criar agente clone > conectar WhatsApp > configurar Localizacao da empresa quando precisar enviar endereco > importar produto ConnectyHub ou cadastrar produto proprio > testar atendimento.",
    ...
    "- Campanhas: Atendimento > Configurar agente > Grupos e campanhas. A tela abre o fluxo Campanhas WhatsApp: atualizar/buscar destinos, selecionar grupos ou canais, criar mensagem, revisar e agendar.",
    "",
    "Conexao",
    ...
    "",
    "Grupos e campanhas",
    "- Caminho: Atendimento > Configurar agente > Grupos e campanhas.",
    "- Uso principal: atualizar painel, buscar grupos/canais, escolher destinos, criar mensagem com texto/midia/audio/produtos, revisar e agendar campanha.",
    "- Configuracoes avancadas guarda regras de resposta em grupos, status, canais, campanhas em lote, limites e delays.",
    "- Ferramentas e diagnostico guarda detalhes de grupos, limites, pastas e rastreamento.",
    "- Envios rapidos e avancados guarda Status WhatsApp, campanha simples por lista manual e postagem direta em canal/newsletter.",
    ...
    "- Campanhas nao fica mais no menu lateral. Caminho correto: Atendimento > Configurar agente > Grupos e campanhas; dentro da tela, seguir o fluxo Campanhas WhatsApp.",
