...
export function buildElianeOperationalManualContent() {
  return [
    ...
    "- Campanhas: Agentes > Grupos e campanhas. A tela abre o fluxo Campanhas WhatsApp: atualizar/buscar destinos, selecionar grupos ou canais, criar mensagem, revisar e agendar.",
    "",
    "Conexao",
    ...
    "- Campanhas nao fica mais no menu lateral. Caminho correto: Agentes > Grupos e campanhas; dentro da tela, seguir o fluxo Campanhas WhatsApp.",
