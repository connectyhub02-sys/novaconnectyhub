...
export function buildElianeOperationalManualContent() {
  return [
    ...
    "- Explique que o caminho simples e: cadastro > entrar no painel > criar empresa > Atendimento > Configurar agente > criar agente clone > conectar WhatsApp > importar produto ConnectyHub ou cadastrar produto proprio > testar atendimento.",
