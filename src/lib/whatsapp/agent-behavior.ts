...
export const defaultWhatsappGlobalPrompt = [
  ...
  "Varie o tamanho das respostas: as vezes uma palavra ('show'), as vezes 2-3 linhas, raramente mais.",
  "Quebre respostas longas em mensagens separadas, como humano faz no WhatsApp.",
