...
export async function getOrganizationBillingAccess(input: {
  ...
  if (isTrial && balanceCredits <= 0) {
    return {
      ...
      lowCreditThreshold,
      bannerTone: "rose",
      bannerTitle: "Creditos do teste acabaram",
      bannerDescription: "Os creditos do teste gratis acabaram. Seus dados continuam salvos, mas os agentes e recursos com custo ficam pausados ate voce escolher um plano.",
      ctaLabel: "Escolher plano",
      ctaHref: "/dashboard/planos",
    };
  }
