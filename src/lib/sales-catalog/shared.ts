...
export type SalesCatalogPagBankSettings = {
  enabledMethods: SalesCatalogPagBankPaymentMethod[];
...
export const salesCatalogPaymentMethodTemplates: SalesCatalogPaymentMethod[] = [
  ...
  },
  {
    ...
    enabled: false,
    instructions: "Enviar checkout seguro ConnectyHub depois de confirmar produto, frete e dados do lead.",
    requiresProof: false,
  },
  {
    id: "boleto",
    label: "Boleto",
    enabled: false,
    instructions: "Disponibilizar boleto somente no checkout ConnectyHub depois de confirmar dados do lead.",
    requiresProof: false,
  },
  {
    id: "cash_on_delivery",
...
export const salesCatalogPagBankPaymentMethodOptions: Array<{
  ...
  { id: "debit_card", label: "Cartao de debito" },
