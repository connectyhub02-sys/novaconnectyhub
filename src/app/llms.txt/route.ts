...
export async function GET() {
  ...
  const lines = [
    ...
    `- AI API and credit calculation: ${buildCanonicalUrl("/docs/api#ia")}`,
    ...
    `- Estúdio de Voz e Áudio AI: ${buildCanonicalUrl("/#estudio-voz")} — Private project voices and audio tools, charged in ConnectyHub credits.`,
    ...
    "- Voice tools are enabled individually. Only authenticated GET /api/v1/voice/capabilities with available=true confirms availability for a project; documentation is not an activation guarantee.",
    "- Free or trial account access remains subject to contract, credits and storage. It does not mean unlimited or free audio generation.",
