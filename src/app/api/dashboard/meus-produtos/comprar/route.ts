...
import { loadBillingCheckoutIntent } from "@/lib/billing/plan-checkout";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { data: product, error } = await client.from("platform_products").select("id,name,price,offer,billing_cycle,billing_interval,metadata")
