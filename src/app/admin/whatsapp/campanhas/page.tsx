...
export const metadata: Metadata = {
  ...
  description: "Grupos, canais, status e campanhas dos agentes WhatsApp internos da ConnectyHub.",
};

export default async function AdminWhatsappCampanhasPage() {
  await connection();
