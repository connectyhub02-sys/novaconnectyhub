...
const adminSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "API de Voz",               href: "/admin/voz",               icon: Megaphone, tone: "violet" },
    ],
  },
  {
    label: "Sistema",
...
const clientSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "API de Voz",              href: "/dashboard/voz",              icon: Megaphone, tone: "violet" },
...
function ConnectyShellRoot({
  ...
  const shellTheme = {
    ...
    "--chart-3":       "var(--ch-chart-3)",
    "--chart-4":       "var(--ch-chart-4)",
    "--chart-5":       "var(--ch-chart-5)",
  } as CSSProperties;
...
function billingBannerTone(tone: BillingAccessClientStatus["bannerTone"]) {
  const tones = {
    green: {
      ...
      border: "rgba(var(--ch-success-rgb),0.34)",
      background: "rgba(var(--ch-success-rgb),0.12)",
      iconBackground: "rgba(var(--ch-success-rgb),0.14)",
    },
    amber: {
      color: "var(--ch-warning)",
      border: "rgba(var(--ch-warning-rgb),0.34)",
      background: "rgba(var(--ch-warning-rgb),0.12)",
      iconBackground: "rgba(var(--ch-warning-rgb),0.14)",
    },
    rose: {
      color: "var(--ch-danger)",
      border: "rgba(var(--ch-danger-rgb),0.34)",
      background: "rgba(var(--ch-danger-rgb),0.12)",
      iconBackground: "rgba(var(--ch-danger-rgb),0.14)",
    },
    cyan: {
      color: "var(--ch-brand-primary)",
      border: "rgba(var(--ch-brand-primary-rgb),0.30)",
      background: "rgba(var(--ch-brand-primary-rgb),0.10)",
      iconBackground: "rgba(var(--ch-brand-primary-rgb),0.12)",
    },
...
function notificationToneColor(tone: NotificationTone = "zinc") {
  const colors: Record<NotificationTone, string> = {
    green: "var(--ch-success)",
    cyan: "var(--ch-brand-primary)",
    amber: "var(--ch-warning)",
    rose: "var(--ch-danger)",
    zinc: "var(--ch-subtle)",
  };
...
function notificationToneBackground(tone: NotificationTone = "zinc") {
  const backgrounds: Record<NotificationTone, string> = {
    green: "rgba(var(--ch-success-rgb),0.10)",
    cyan: "rgba(var(--ch-brand-primary-rgb),0.10)",
    amber: "rgba(var(--ch-warning-rgb),0.10)",
    rose: "rgba(var(--ch-danger-rgb),0.10)",
    zinc: "rgba(100,116,139,0.10)",
  };
...
function notificationToneBorder(tone: NotificationTone = "zinc") {
  const borders: Record<NotificationTone, string> = {
    green: "rgba(var(--ch-success-rgb),0.22)",
    cyan: "rgba(var(--ch-brand-primary-rgb),0.22)",
    amber: "rgba(var(--ch-warning-rgb),0.26)",
    rose: "rgba(var(--ch-danger-rgb),0.24)",
    zinc: "rgba(100,116,139,0.16)",
  };
