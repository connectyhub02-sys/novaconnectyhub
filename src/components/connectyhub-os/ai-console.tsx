...
export function AiConsole() {
  ...
  return <div className="mx-auto max-w-6xl space-y-6 text-slate-900">
    <header className="flex flex-wrap items-start justify-between gap-4"><div><p className="text-xs font-bold uppercase tracking-[.18em] text-blue-700">Seus projetos conectados</p><h1 className="mt-2 text-3xl font-bold">API de AI</h1><p className="mt-2 max-w-2xl text-sm leading-7 text-slate-600">Crie um projeto, copie sua chave e comece a usar. Acompanhe tudo em créditos ConnectyHub.</p></div><Link className={primary} href="/docs/api#ia"><Code2 size={17}/>Documentação</Link></header>
