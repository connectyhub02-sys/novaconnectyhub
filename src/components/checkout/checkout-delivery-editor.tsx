...
type Quote = { needsLocation?: boolean; customer: Customer; requireAddress: boolean; physical: boolean; quotes: OrderDeliveryQuote[]; selectedId: string; revision: number; subtotal: number; discount: number; error: string | null };
