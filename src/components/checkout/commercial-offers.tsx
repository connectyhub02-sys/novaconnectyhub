...
export function CommercialOffers({ organizationId, surface, currentProductIds = [], onAdd, title = "Combine com seu pedido", addLabel = "Adicionar", paymentSessionId }: Props) {
  ...
  useEffect(() => {
    if (!container.current || !offers.length) return;
