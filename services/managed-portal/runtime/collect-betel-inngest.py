...
APP_ID='5aa137bc-fe2b-5385-8e94-138d6d054335'
...
def collect():
    ...
    if not app or app['externalID']!='betel-ai' or app['url']!='http://172.18.0.1:28111/api/inngest':raise ValueError('Application identity changed')
