...
const exposed = [
  ...
  "buildSalesCatalogLines", "stripRuntimeNotes", "resolveOrderToolScope", "executeOrderTool", "runOrderToolTurn", "sendOrderToolTurn", "claimsUnexecutedOrderAction", "formatSalesCatalogCustomerMention", "runtimeAllowsCheckout", "effectiveRuntimeDestination", "resolveCatalogAgendaFocus",
];
