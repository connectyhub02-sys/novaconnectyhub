...
const exposed = [
  ...
  "buildSalesCatalogLines", "stripRuntimeNotes", "resolveOrderToolScope", "resolveCartToolScope", "orderToolFallbackText", "extractRuntimeAddress", "hasRuntimeCompleteDeliveryAddress", "extractRuntimeCustomerName", "selectCartComplements", "buildCartComplementSuggestionLines", "missingCheckoutBillingLabels", "dropRepeatedCatalogMentionLines", "buildCustomerCheckoutDataLines", "executeOrderTool", "runOrderToolTurn", "sendOrderToolTurn", "claimsUnexecutedOrderAction", "formatSalesCatalogCustomerMention", "runtimeAllowsCheckout", "effectiveRuntimeDestination", "resolveCatalogAgendaFocus",
];
